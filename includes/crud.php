...
class Database
{
    ...
    private $db_user = "u743445510_gandhimarket";  // Change as required
    private $db_pass = "Gandhimarket@2024";  // Change as required
    private $db_name = "u743445510_gandhimarket";    // Change as required
